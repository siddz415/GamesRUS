...
export const reducer = (state, action) => {
  switch (action.type) {
    // Returns a copy of state with an update games array. We use the action.games property and spread it's contents into the new array.
    case UPDATE_GAMES:
      return {
        ...state,
        games: [...action.games],
    ...
    // First we iterate through each item in the cart and check to see if the `game._id` matches the `action._id`
